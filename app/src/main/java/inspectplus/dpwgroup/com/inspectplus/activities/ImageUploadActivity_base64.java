...
public class ImageUploadActivity_base64 extends ActionBarActivity {
...
//                    adapterProjList.setProjectsList(listProjects);
                    ...
                    if (!obj.equals("ERROR")) {
                        ...
                        if(obj.equals("OK")){
                            hideDialog();
                            Toast.makeText(getApplicationContext(), "The Image and Notes have been uploaded " ,
                                    Toast.LENGTH_LONG).show();
                        }
                        // Add to sqlite db
...
//								errorMsg, Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                String message = VolleyErrorHelper.getMessage(error, ImageUploadActivity_base64.this);
...
//                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.upload) {
            Intent intent = new Intent(ImageUploadActivity_base64.this, ImageGalleryActivity.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ImageUploadActivity_base64.this, SplashActivity.class);
        startActivity(intent);
        finish();
    }
    private void getGPS(){
        gps = new GPSTracker(ImageUploadActivity_base64.this);
